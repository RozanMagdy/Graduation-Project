...
/* PB structure used with read/wrire group chaanel */
const Dio_ChannelGroupType Dio_LEDGroupConfiguration =
{
	DioconfigGroup_LED_Mask,DioConfigGroup_LED_Offset,DioConfGroup_LED_Port	
};

const Dio_ChannelGroupType Dio_BUTTONGroupConfiguration =
{
	DioconfigGroup_BUTTON_Mask,DioConfigGroup_BUTTON_Offset ,DioConfGroup_BUTTON_Port	
};
