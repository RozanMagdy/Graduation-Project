...
#define	PORT_PIN_DIRECTION_INITIAL_VALUE		(Port_PinDirectionType)(PORT_PIN_IN)
...
#define PORT_PIN_DRIVEN_MODE_INITIAL_VALUE		(Port_PinDrivenModeType)(GPIO_Push_Pull)
