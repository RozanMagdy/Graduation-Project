...
typedef enum
{
    PORT_Pin_Level_low , PORT_Pinn_Level_High
} Port_PinLevelType;
...
#if(IS_PORT_DIRECTION_CHANGEABLE_DURING_RUNTIME == STD_OFF)
void Port_SetPinDirection(Port_PinType Pin,Port_PinDirectionType Direction);
void Port_RefreshPortDirection(void);
#endif

#if(IS_PORT_MODE_CHANGEABLE_DURING_RUNTIME == STD_OFF) // mode, not driven mode
